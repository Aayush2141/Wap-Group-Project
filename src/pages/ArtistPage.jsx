...
import { Play, Pause, Users, Heart, Clock, ArrowLeft, Music2 } from 'lucide-react';
...
export default function ArtistPage() {
  ...
  // Generate a consistent gradient color from artist name (no external image needed)
  ...
  return (
    <div className="page-enter">
      ...
      {loading ? (
        ...
        >
          {/* Artist avatar — gradient initials (iTunes has no artist photo) */}
          <motion.div
          ...
          <div>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-[#1db954] text-xs font-bold uppercase tracking-widest mb-2"
            >
              Artist
            </motion.p>
            <motion.h1
              ...
              className="text-4xl md:text-5xl font-black text-white leading-none mb-2 drop-shadow-lg"
            >
              {artistName}
            </motion.h1>
            <motion.p
      ...
      <div className="px-6 pb-8">
        ...
        {!loading && songs.length > 0 && (
          <div
            className="grid items-center gap-4 px-4 py-2 mb-1 text-[#535353] text-xs font-bold uppercase tracking-wider border-b border-white/[0.06]"
            style={{ gridTemplateColumns: '28px 48px 1fr auto auto' }}
          >
